"""
Django settings for damp_wave_42768 project.
...
ROOT_URLCONF = 'damp_wave_42768.urls'
...
WSGI_APPLICATION = 'damp_wave_42768.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_wave_42768 API",
    "DESCRIPTION": "API documentation for damp_wave_42768 App",
    "VERSION": "v1",
}
